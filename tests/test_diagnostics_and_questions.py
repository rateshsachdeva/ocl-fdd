...
def test_new_cliff_and_stale_patterns_create_focused_questions():
    records = [
        _record("New accrual", "Other", "FY24", 0),
        _record("New accrual", "Other", "FY25", 100),
        _record("Settled accrual", "Other", "FY24", 80),
        _record("Settled accrual", "Other", "FY25", 0),
    ]
    for period in ("2025-09", "2025-10", "2025-11", "2025-12"):
        records.append(_record("Old accrual", "Other", period, 50, "MONTHLY_RECORDS"))
    ...
    assert "settled or released" in text
