...
def _build_config(root: Path) -> Path:
    ...
    _write_csv(root / "judgment_wc_debt.csv", ["source_label", "source_code", "entity", "management_view", "fdd_view", "normality", "review_status", "reason"], [
        ...
        ["Holiday pay", "2110", "Entity A", "working_capital", "working_capital", "normal", "REVIEWED", ""],
        ["VAT payable", "2120", "Entity A", "working_capital", "debt_like", "normal", "REVIEWED", "Statutory balance assessed as debt-like for synthetic test"],
        ["Trade payables", "2000", "Entity A", "", "", "", "REVIEWED", ""],
    ])
    handoff = {
        "handoff_version": "1.0", "status": "CONFIRMED", "package_id": "SYNTH-001",
        "datasets": [
        ...
        "unresolved_matters": [],
        "monthly_to_annual": [{"annual_period": "FY24", "monthly_period": "2024-12"}, {"annual_period": "FY25", "monthly_period": "2025-12"}],
        "controls": [{"control_id": "chk_listing_vs_tb", "dataset_file": "tb_control.csv", "period_field": "Period", "amount_field": "Amount", "filters": {"Control": ["OCL"]}}],
    }
