...
The embedded vendored runtime still owns **when and how it reasons from runtime knowledge** while understanding a dataset. This folder owns the repository-level boundary between built-in knowledge, one engagement's runtime learning and cross-source reusable learning.
...
The three reusable runtime knowledge assets remain:
...
The persistent store is gitignored because it can reflect locally accumulated engagement experience.
